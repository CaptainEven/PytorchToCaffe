...
if __name__ == '__main__':
    ...
    opt = {
        'img_size': 768,
        'cfg': '/mnt/diskb/even/YOLOV4/cfg/yolov4_mobilev2_2l.cfg',
        'device': 'cpu',  # '0'
        'weights': '/mnt/diskb/even/YOLOV4/weights/yolov4_mobilenetv2_2l_track_last.pt',
    }
    ...
    name = 'mcmot_yolov4_mibilenetv2_2l'
